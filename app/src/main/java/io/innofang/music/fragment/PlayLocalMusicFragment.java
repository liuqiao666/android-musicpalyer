package io.innofang.music.fragment;
...
import io.innofang.music.adapter.MusicAdapter;
import io.innofang.music.bean.Song;
import io.innofang.music.utils.AudioUtils;
import io.innofang.music.utils.RequestPermissions;
...
//            File file = new File(song.getFileUrl());
            ...
            activity.getSupportActionBar().setSubtitle(song.getSinger());
